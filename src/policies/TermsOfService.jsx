      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="space-y-12 text-zinc-600 leading-relaxed text-[15px]">
          <section className="space-y-6">
            ...
            <p>
              We are <strong>Get Your Driver</strong> ("Company," "we," "us," or "our"), a company registered in china, 130 S Fillmore St, Corinth, MS 38834, United States.
            </p>
            <p>
            ...
            <p>
              Get Your Driver was founded on the principle that household repairs should be handled with the same level of precision as industrial maintenance. We recognize that modern appliances are complex electronic systems that require specialized knowledge and calibrated tools for effective servicing.
            </p>
            <p>
              You can contact us by email at <a href="mailto:info@getyourdriver.shop" className="text-blue-600 font-bold">info@getyourdriver.shop</a>, or by mail to 130 S Fillmore St, Corinth, MS 38834, United States.
            </p>
            <p>
          ...
          <section className="bg-zinc-50 p-8 md:p-12 rounded-[2.5rem] border border-zinc-100">
            <h2 className="text-xl font-black text-zinc-900 uppercase mb-8 ">TABLE OF CONTENTS</h2>
            <nav className="flex flex-col gap-3 text-sm font-bold text-blue-600 uppercase tracking-widest">
              <a href="#1" className="hover:underline">1. OUR SERVICES</a>
              <a href="#2" className="hover:underline">2. INTELLECTUAL PROPERTY RIGHTS</a>
              <a href="#3" className="hover:underline">3. USER REPRESENTATIONS</a>
              <a href="#4" className="hover:underline">4. PROHIBITED ACTIVITIES</a>
              <a href="#5" className="hover:underline">5. USER GENERATED CONTRIBUTIONS</a>
              <a href="#6" className="hover:underline">6. CONTRIBUTION LICENSE</a>
              <a href="#7" className="hover:underline">7. SERVICES MANAGEMENT</a>
              <a href="#8" className="hover:underline">8. PRIVACY POLICY</a>
              <a href="#9" className="hover:underline">9. TERM AND TERMINATION</a>
              <a href="#10" className="hover:underline">10. MODIFICATIONS AND INTERRUPTIONS</a>
              <a href="#11" className="hover:underline">11. GOVERNING LAW</a>
              <a href="#12" className="hover:underline">12. DISPUTE RESOLUTION</a>
              <a href="#13" className="hover:underline">13. CORRECTIONS</a>
              <a href="#14" className="hover:underline">14. DISCLAIMER</a>
              <a href="#15" className="hover:underline">15. LIMITATIONS OF LIABILITY</a>
              <a href="#16" className="hover:underline">16. INDEMNIFICATION</a>
              <a href="#17" className="hover:underline">17. USER DATA</a>
              <a href="#18" className="hover:underline">18. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a>
              <a href="#19" className="hover:underline">19. MISCELLANEOUS</a>
              <a href="#21" className="hover:underline">21. CONTACT US</a>
            </nav>
          </section>

          <div className="space-y-16">
            <section id="1" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">1. OUR SERVICES</h3>
            ...
            <section id="2" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">2. INTELLECTUAL PROPERTY RIGHTS</h3>
              ...
              <p>Except as set out in this section or elsewhere in our Legal Terms, no part of the Services and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted, distributed, sold, licensed, or otherwise exploited for any commercial purpose whatsoever, without our express prior written permission. If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: info@getyourdriver.shop. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
            ...
            <section id="3" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">3. USER REPRESENTATIONS</h3>
            ...
            <section id="6" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">6. CONTRIBUTION LICENSE</h3>
            ...
            <section id="7" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">7. SERVICES MANAGEMENT</h3>
            ...
            <section id="8" className="space-y-6">
              ...
              <p>We care about data privacy and security. Please review our Privacy Policy: <a href="http://getyourdriver.shop/privacy-policy" className="text-blue-600 font-bold">http://getyourdriver.shop/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
            </section>

            <section id="9" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">9. TERM AND TERMINATION</h3>
            ...
            <section id="10" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">10. MODIFICATIONS AND INTERRUPTIONS</h3>
            ...
            <section id="11" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">11. GOVERNING LAW</h3>
            ...
            <section id="12" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">12. DISPUTE RESOLUTION</h3>
            ...
            <section id="13" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">13. CORRECTIONS</h3>
              <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
            </section>

            <section id="14" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">14. DISCLAIMER</h3>
              <p className="font-black text-zinc-900 uppercase text-xs tracking-widest leading-loose">THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE SERVICES AND YOUR USE THEREOF, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SERVICES' CONTENT OR THE CONTENT OF ANY WEBSITES OR MOBILE APPLICATIONS LINKED TO THE SERVICES AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR INACCURACIES OF CONTENT AND MATERIALS, (2) PERSONAL INJURY OR PROPERTY DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SERVICES, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION STORED THEREIN, (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM THE SERVICES, (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SERVICES BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SERVICES. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SERVICES, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE WILL NOT BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY TRANSACTION BETWEEN YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR SERVICES. AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE.</p>
            </section>

            <section id="15" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">15. LIMITATIONS OF LIABILITY</h3>
            ...
            <section id="16" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">16. INDEMNIFICATION</h3>
            ...
            <section id="17" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">17. USER DATA</h3>
              <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
            </section>

            <section id="18" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">18. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
            ...
            <section id="19" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase  border-b border-zinc-100 pb-4">19. MISCELLANEOUS</h3>
            ...
            <section id="21" className="p-10 bg-zinc-900 rounded-[2.5rem] text-white">
              <h3 className="text-xl font-black uppercase mb-6 ">21. CONTACT US</h3>
              ...
              <address className="not-italic text-[11px] font-bold uppercase tracking-[0.2em] leading-relaxed">
               ...
               130 S Fillmore St, Corinth, MS 38834, United States
                <br />
                Email: <strong className="text-white underline">info@getyourdriver.shop</strong>
              </address>
            </section>
          </div>
        </div>
