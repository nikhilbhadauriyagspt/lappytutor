...
const ScannerDriver = () => {
  const benefits = [
    {
      title: 'Clear Image Capture',
      desc: 'Helps your system scan documents with proper clarity and detail.',
    },
    {
      title: 'File Output Support',
      desc: 'Supports saving scans in common formats like PDF and image files.',
    },
    {
      title: 'Accurate Colors',
      desc: 'Ensures scanned images appear natural and consistent.',
    },
  ];
    ...
    <div className="pt-15 bg-white font-['Poppins']">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[620px] border-b border-zinc-100">
        ...
        <div className="flex items-center px-6 md:px-12 lg:px-24 py-20">
          <div className="max-w-[620px]">
            ...
            <p className="text-[#5f6b7a] text-[16px] md:text-[18px] leading-8 mb-10">
              Scanner drivers help your computer communicate with scanning devices.
              They support image capture, file creation, and smooth transfer of scanned
        ...
        <div className="relative bg-[#eaf7ff] min-h-[420px] flex items-center justify-center overflow-hidden">
          ...
          <ScanLine size={240} strokeWidth={1.2} className="relative z-10 text-[#1075b8]" />
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <h2 className="text-[36px] md:text-[42px] font-normal text-[#111827] mb-4">
              Why Scanner Drivers Matter
            </h2>

            <div className="w-[95px] h-[4px] bg-[#1075b8] mb-6"></div>

            <p className="text-[#5f6b7a] text-[16px] leading-8">
              Scanner drivers help your system capture documents accurately and
              convert them into usable digital files.
            </p>
          </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <ul className="space-y-3 text-[#5f6b7a] text-[15px] leading-7">
                <li>Scanner not detected by the system</li>
                <li>Scan process not starting properly</li>
                <li>Lines or distortion in scanned images</li>
                <li>File not saving correctly</li>
              </ul>
            </div>
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <p className="text-[#5f6b7a] text-[15px] leading-8">
                Scanner drivers support image clarity, file handling, device
                communication, and smooth scanning performance.
              </p>
            </div>
