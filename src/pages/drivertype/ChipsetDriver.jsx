...
import { Cpu, ShieldCheck, Zap, AlertTriangle, ArrowRight, CheckCircle2 } from 'lucide-react';
import { Link } from 'react-router-dom';

const ChipsetDriver = () => {
  const benefits = [
    { title: "Hardware Communication", desc: "Ensures CPU, RAM, and Motherboard sync perfectly." },
    { title: "Power Management", desc: "Optimizes power delivery to various components." },
    { title: "Stability", desc: "Prevents system crashes and unexpected reboots." },
    { title: "Peripheral Support", desc: "Enables proper detection of USB and SATA ports." }
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-100 text-blue-600 mb-6">
              <Cpu size={14} />
              <span className="text-[11px] font-bold uppercase tracking-widest">System Foundation</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-black text-zinc-900 leading-[1.1] mb-8">
              Chipset <span className="text-blue-600">Drivers</span>
            </h1>
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-24">
          <div className="p-10 bg-zinc-900 rounded-[40px] text-white">
            <h2 className="text-3xl font-bold mb-6">What is a Chipset?</h2>
            <p className="text-zinc-400 leading-relaxed">
              Think of the chipset as the central nervous system of your computer. It controls the flow of data between the processor and external devices. It is responsible for managing everything from your system clock to your PCIe lanes and USB controllers.
            </p>
          </div>
          <div className="md:col-span-2 grid sm:grid-cols-2 gap-8">
            <div className="p-8 border border-zinc-100 rounded-[32px] hover:border-blue-100 transition-colors">
              ...
              <ul className="space-y-3 text-zinc-600 text-sm">
                <li className="flex items-center gap-2">• Slow data transfer speeds</li>
                <li className="flex items-center gap-2">• Unrecognized USB devices</li>
                <li className="flex items-center gap-2">• System instability/Blue Screens</li>
                <li className="flex items-center gap-2">• High CPU idle temperatures</li>
              </ul>
            </div>
            <div className="p-8 border border-zinc-100 rounded-[32px] hover:border-blue-100 transition-colors">
              ...
              <p className="text-zinc-600 text-sm leading-relaxed">
                Updating chipset drivers can unlock better power efficiency for laptops, improve SSD performance, and ensure compatibility with the latest Windows updates and hardware peripherals.
              </p>
            </div>
          </div>
        </div>
