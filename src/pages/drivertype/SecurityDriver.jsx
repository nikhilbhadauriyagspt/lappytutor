  ...
  const benefits = [
    {
      ...
      desc: 'Helps your system manage secure login features like fingerprint or device authentication.',
    },
    {
      title: 'System Protection',
      desc: 'Supports safe communication between hardware and system processes.',
    },
    {
      title: 'Data Safety',
      desc: 'Helps protect stored information through system-level security features.',
    },
  ];
    ...
    <div className="pt-15 bg-white font-['Poppins']">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[620px] border-b border-zinc-100">
        ...
        <div className="flex items-center px-6 md:px-12 lg:px-24 py-20">
          <div className="max-w-[620px]">
            ...
            <p className="text-[#5f6b7a] text-[16px] md:text-[18px] leading-8 mb-10">
              Security drivers help your computer manage hardware-based protection
              features. They support safe system access, protect data, and ensure
              secure communication between your device and its components.
            </p>
        ...
        <div className="relative bg-[#eaf7ff] min-h-[420px] flex items-center justify-center overflow-hidden">
          ...
          <ShieldCheck size={240} strokeWidth={1.2} className="relative z-10 text-[#1295ea]" />
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <h2 className="text-[36px] md:text-[42px] font-normal text-[#111827] mb-4">
              Why Security Drivers Matter
            </h2>

            <div className="w-[95px] h-[4px] bg-[#1295ea] mb-6"></div>

            <p className="text-[#5f6b7a] text-[16px] leading-8">
              Security drivers help your system maintain safe operations and protect
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <ul className="space-y-3 text-[#5f6b7a] text-[15px] leading-7">
                <li>Security features not working properly</li>
                <li>Fingerprint or login issues</li>
                <li>Security device not detected</li>
                <li>Unexpected access or permission problems</li>
              </ul>
            </div>
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <p className="text-[#5f6b7a] text-[15px] leading-8">
                Security drivers support safe authentication, system protection,
                secure data handling, and reliable device access control.
              </p>
            </div>
