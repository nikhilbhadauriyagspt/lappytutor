...
const PowerManagementDriver = () => {
  const benefits = [
    {
      title: 'Balanced Power Usage',
      desc: 'Helps your system manage power between performance and energy saving.',
    },
    {
      title: 'System Temperature',
      desc: 'Supports stable temperature by adjusting hardware activity.',
    },
    {
      title: 'Battery Efficiency',
      desc: 'Improves how your system uses battery during everyday tasks.',
    },
  ];
    ...
    <div className="pt-15 bg-white font-['Poppins']">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[620px] border-b border-zinc-100">
        ...
        <div className="flex items-center px-6 md:px-12 lg:px-24 py-20">
          <div className="max-w-[620px]">
            ...
            <p className="text-[#5f6b7a] text-[16px] md:text-[18px] leading-8 mb-10">
              Power management drivers help your computer control how energy is used
              across different components. They balance performance, temperature, and
              battery usage to keep your system running efficiently.
            </p>
        ...
        <div className="relative bg-[#eaf7ff] min-h-[420px] flex items-center justify-center overflow-hidden">
          ...
          <Zap size={240} strokeWidth={1.2} className="relative z-10 text-[#1295ea]" />
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <h2 className="text-[36px] md:text-[42px] font-normal text-[#111827] mb-4">
              Why Power Drivers Matter
            </h2>

            <div className="w-[95px] h-[4px] bg-[#1295ea] mb-6"></div>

            <p className="text-[#5f6b7a] text-[16px] leading-8">
              These drivers help your system manage energy flow and maintain a balance
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <ul className="space-y-3 text-[#5f6b7a] text-[15px] leading-7">
                ...
                <li>System heating more than usual</li>
                <li>Fan running constantly</li>
                <li>Sleep or wake issues</li>
              </ul>
            </div>
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <p className="text-[#5f6b7a] text-[15px] leading-8">
                Power drivers support battery efficiency, system cooling, balanced
                performance, and smooth switching between power states.
              </p>
            </div>
