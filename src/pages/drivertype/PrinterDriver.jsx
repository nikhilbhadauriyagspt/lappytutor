  ...
  const benefits = [
    {
      ...
      desc: 'Helps documents print with correct layout, text, and formatting.',
    },
    {
      title: 'Smooth Print Jobs',
      desc: 'Supports proper handling of multiple or large print tasks.',
    },
    {
      title: 'Device Features',
      desc: 'Enables options like paper size, quality settings, and basic controls.',
    },
  ];
    ...
    <div className="pt-15 bg-white font-['Poppins']">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[620px] border-b border-zinc-100">
        ...
        <div className="flex items-center px-6 md:px-12 lg:px-24 py-20">
          <div className="max-w-[620px]">
            ...
            <p className="text-[#5f6b7a] text-[16px] md:text-[18px] leading-8 mb-10">
              Printer drivers help your computer send documents to a printer in a format
              it can understand. They support proper layout, clear output, and smooth
              communication between your system and the printer.
            </p>
        ...
        <div className="relative bg-[#eaf7ff] min-h-[420px] flex items-center justify-center overflow-hidden">
          ...
          <Printer size={240} strokeWidth={1.2} className="relative z-10 text-[#1075b8]" />
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[#5f6b7a] text-[16px] leading-8">
              Printer drivers help your system communicate clearly with your printer,
              ensuring documents are printed correctly and consistently.
            </p>
          </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <ul className="space-y-3 text-[#5f6b7a] text-[15px] leading-7">
                <li>Printer not responding or showing offline</li>
                <li>Incorrect or broken print layout</li>
                <li>Print jobs getting stuck</li>
                <li>Missing print options in settings</li>
              </ul>
            </div>
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <p className="text-[#5f6b7a] text-[15px] leading-8">
                Printer drivers support document formatting, print queue handling,
                device communication, and consistent printing performance.
              </p>
            </div>
