  ...
  const benefits = [
    {
      ...
      desc: 'Helps your system detect and connect USB devices correctly.',
    },
    {
      title: 'Data Transfer',
      desc: 'Supports smooth transfer of files between devices.',
    },
    {
      title: 'Power Delivery',
      desc: 'Allows connected devices to receive proper power from USB ports.',
    },
  ];
    ...
    <div className="pt-15 bg-white font-['Poppins']">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[620px] border-b border-zinc-100">
        ...
        <div className="flex items-center px-6 md:px-12 lg:px-24 py-20">
          <div className="max-w-[620px]">
            ...
            <p className="text-[#5f6b7a] text-[16px] md:text-[18px] leading-8 mb-10">
              USB drivers help your computer communicate with external devices such as
              flash drives, keyboards, webcams, and other accessories. They support
              proper connection, data transfer, and device functionality.
            </p>
        ...
        <div className="relative bg-[#eaf7ff] min-h-[420px] flex items-center justify-center overflow-hidden">
          ...
          <Usb size={240} strokeWidth={1.2} className="relative z-10 text-[#1295ea]" />
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <h2 className="text-[36px] md:text-[42px] font-normal text-[#111827] mb-4">
              Why USB Drivers Matter
            </h2>

            <div className="w-[95px] h-[4px] bg-[#1295ea] mb-6"></div>

            <p className="text-[#5f6b7a] text-[16px] leading-8">
              USB drivers help your system manage external devices and ensure they
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <ul className="space-y-3 text-[#5f6b7a] text-[15px] leading-7">
                ...
                <li>Slow data transfer speed</li>
                <li>Devices disconnecting randomly</li>
                <li>Ports not responding properly</li>
              </ul>
            </div>
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <p className="text-[#5f6b7a] text-[15px] leading-8">
                USB drivers support device detection, stable connections, reliable
                data transfer, and proper functioning of connected accessories.
              </p>
            </div>
