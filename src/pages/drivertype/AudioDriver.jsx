...
import { Volume2, CheckCircle2, AlertTriangle, Headphones, Mic, Radio } from 'lucide-react';
import { Link } from 'react-router-dom';

const AudioDriver = () => {
  const benefits = [
    {
      title: 'Clear Sound Output',
      desc: 'Helps speakers and headphones produce sound properly.',
      icon: Headphones,
    },
    {
      title: 'Microphone Access',
      desc: 'Helps your system recognize microphones for recording or calls.',
      icon: Mic,
    },
    {
      title: 'Better Audio Control',
      desc: 'Supports volume, input, output, and sound setting behavior.',
      icon: Radio,
    },
  ];
    ...
    <div className="pt-15 bg-white font-['Poppins']">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[620px] border-b border-zinc-100">
        <div className="flex items-center px-6 md:px-12 lg:px-24 py-20">
          <div className="max-w-[620px]">
            ...
            <p className="text-[#5f6b7a] text-[16px] md:text-[18px] leading-8 mb-10">
              Audio drivers help your computer understand and manage sound-related
              devices like speakers, headphones, and microphones. They support clear
              sound output, proper input detection, and smoother everyday audio use.
            </p>
        ...
        <div className="relative bg-[#eaf7ff] min-h-[420px] flex items-center justify-center overflow-hidden">
          ...
          <Volume2 size={260} strokeWidth={1.2} className="relative z-10 text-[#1295ea]" />
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-1">
            ...
            <p className="text-[#5f6b7a] text-[16px] leading-8">
              A suitable audio driver helps your system understand how to send and
              receive sound through the correct device.
            </p>
          </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <ul className="space-y-3 text-[#5f6b7a] text-[15px] leading-7">
                <li>No sound from speakers or headphones</li>
                <li>Microphone not showing in settings</li>
                <li>Crackling, delay, or low-quality sound</li>
                <li>Audio device not detected after an update</li>
              </ul>
            </div>
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <p className="text-[#5f6b7a] text-[15px] leading-8">
                Audio drivers support sound output, microphone input, volume controls,
                device switching, and basic sound stability across everyday system use.
              </p>
            </div>
          </div>
        </div>
