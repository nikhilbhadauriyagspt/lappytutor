...
import { Webcam, CheckCircle2, AlertTriangle } from 'lucide-react';
import { Link } from 'react-router-dom';

const WebcamDriver = () => {
  const benefits = [
    {
      title: 'Clear Video Capture',
      desc: 'Helps your system capture video with proper clarity and detail.',
    },
    {
      title: 'Smooth Streaming',
      desc: 'Supports stable video during calls and recordings.',
    },
    {
      title: 'Camera Recognition',
      desc: 'Ensures your system detects and uses the camera correctly.',
    },
  ];
    ...
    <div className="pt-15 bg-white font-['Poppins']">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[620px] border-b border-zinc-100">
        ...
        <div className="flex items-center px-6 md:px-12 lg:px-24 py-20">
          <div className="max-w-[620px]">
            ...
            <p className="text-[#5f6b7a] text-[16px] md:text-[18px] leading-8 mb-10">
              Webcam drivers help your computer communicate with your camera device.
              They support video capture, smooth streaming, and proper camera functionality.
            </p>
        ...
        <div className="relative bg-[#eaf7ff] min-h-[420px] flex items-center justify-center overflow-hidden">
          ...
          <Webcam size={240} strokeWidth={1.2} className="relative z-10 text-[#1075b8]" />
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <h2 className="text-[36px] md:text-[42px] font-normal text-[#111827] mb-4">
              Why Webcam Drivers Matter
            </h2>

            <div className="w-[95px] h-[4px] bg-[#1075b8] mb-6"></div>

            <p className="text-[#5f6b7a] text-[16px] leading-8">
              Webcam drivers help your system manage camera access and ensure smooth
              video functionality across different applications.
            </p>
          </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <ul className="space-y-3 text-[#5f6b7a] text-[15px] leading-7">
                <li>Camera not detected by the system</li>
                <li>Video appearing blurry or low quality</li>
                <li>Camera freezing during use</li>
                <li>Applications unable to access camera</li>
              </ul>
            </div>
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <p className="text-[#5f6b7a] text-[15px] leading-8">
                Webcam drivers support video clarity, stable streaming, proper
                device recognition, and smooth camera performance.
              </p>
            </div>
