...
import { Keyboard, CheckCircle2, AlertTriangle } from 'lucide-react';
import { Link } from 'react-router-dom';

const InputDriver = () => {
  const benefits = [
    {
      title: 'Smooth Input Response',
      desc: 'Helps your keyboard and mouse respond correctly to every action.',
    },
    {
      title: 'Touchpad Behavior',
      desc: 'Supports scrolling, gestures, and basic touchpad movements.',
    },
    {
      title: 'Device Interaction',
      desc: 'Ensures your system understands input from connected devices.',
    },
  ];
    ...
    <div className="pt-15 bg-white font-['Poppins']">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[620px] border-b border-zinc-100">
        ...
        <div className="flex items-center px-6 md:px-12 lg:px-24 py-20">
          <div className="max-w-[620px]">
            ...
            <p className="text-[#5f6b7a] text-[16px] md:text-[18px] leading-8 mb-10">
              Input drivers help your computer understand actions from devices like
              keyboards, mice, and touchpads. They support accurate typing, smooth
              cursor movement, and reliable interaction with your system.
            </p>
        ...
        <div className="relative bg-[#eaf7ff] min-h-[420px] flex items-center justify-center overflow-hidden">
          ...
          <Keyboard size={240} strokeWidth={1.2} className="relative z-10 text-[#1075b8]" />
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            <h2 className="text-[36px] md:text-[42px] font-normal text-[#111827] mb-4">
              Why Input Drivers Matter
            </h2>

            <div className="w-[95px] h-[4px] bg-[#1075b8] mb-6"></div>

            <p className="text-[#5f6b7a] text-[16px] leading-8">
              Input drivers help your system understand user actions and convert them
              into commands, making everyday interaction smooth and accurate.
            </p>
          </div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <ul className="space-y-3 text-[#5f6b7a] text-[15px] leading-7">
                <li>Keyboard keys not responding properly</li>
                <li>Mouse movement lag or delay</li>
                <li>Touchpad gestures not working</li>
                <li>Unexpected input behavior</li>
              </ul>
            </div>
            ...
            <div className="border border-zinc-100 rounded-[18px] p-8 shadow-sm">
              ...
              <p className="text-[#5f6b7a] text-[15px] leading-8">
                Input drivers support typing accuracy, cursor movement, gesture
                control, and smooth communication between your system and input devices.
              </p>
            </div>
