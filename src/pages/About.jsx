...
const About = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-['Poppins'] text-[#111827] overflow-hidden">
      ...
      {/* Top Blue Banner */}
      <section className="relative bg-[#1075b8] py-20 md:py-24 text-center overflow-hidden">
        ...
        <div className="relative z-10 px-6">
          ...
          <p className="text-white text-[15px] md:text-[17px] max-w-[650px] mx-auto leading-8">
      ...
      <section className="relative pt-20 pb-10 px-6 md:px-12 lg:px-24 text-center">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="w-[90px] h-[3px] bg-[#1075b8] mx-auto mb-7"></div>
      ...
      <section className="relative pt-8 pb-20 overflow-hidden">
        <div className="max-w-[1500px] mx-auto px-6">
          <div className="relative min-h-[430px] flex items-end justify-center">
            <div className="absolute bottom-0 left-0 right-0 h-[6px] bg-[#1075b8] rounded-full"></div>

            <div className="w-full grid grid-cols-2 md:grid-cols-6 gap-6 items-end text-[#1075b8]">
              {topics.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-[96px] h-[96px] md:w-[120px] md:h-[120px] rounded-full border-[3px] border-[#1075b8] flex items-center justify-center bg-white shadow-sm mb-5">
          ...
          {values.map((item, index) => {
            ...
            return (
              <div key={index} className="flex flex-col items-center">
                <div className="w-[88px] h-[88px] rounded-full bg-white border border-zinc-200 shadow-sm flex items-center justify-center text-[#1075b8] mb-7">
      ...
      <section className="py-22 md:py-28 px-6 md:px-12 lg:px-24 bg-white">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="border border-zinc-100 rounded-[24px] p-8 md:p-10 shadow-sm">
            <Target className="text-[#1075b8] mb-6" size={36} />
          ...
          <div className="border border-zinc-100 rounded-[24px] p-8 md:p-10 shadow-sm">
            <Eye className="text-[#1075b8] mb-6" size={36} />
      ...
      {/* Trust Line */}
      <section className="bg-[#1075b8] py-16 text-center px-6">
        <div className="max-w-[900px] mx-auto">
          ...
          <p className="text-white text-[16px] leading-8 max-w-[720px] mx-auto mb-9">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-3 bg-white text-[#1075b8] px-10 py-4 rounded-[4px] font-medium hover:bg-[#f3f8ff] transition"
          >
